...
重大更新：卷规划与章节执行进入“节奏 - 章节 - 场景”一体化推进视图，兑现压力、章节细化与字数控制可以同屏掌握。
- 伏笔账本更清楚：大纲页新增 canonical 伏笔账本与卷内兑现关联提示，待回收、紧急与逾期压力一眼可见。
- 节奏到章节更顺：节奏板 + 章节列表联动，按节奏分组查看章节并提示未映射章节。
- 章节执行更可控：推荐下一步动作、任务单/场景卡生成与字数控制回收集中展示，写作更稳。
- 后台推进更直观：小说列表与工作区新增运行中提示与进度条。
